...
# @Last Modified time: 2019-03-16 13:46:10

import wx;

from _Global import _GG;

from TitleGridsViewUI import *;
...
class TitleGridsViewCtr(object):
	"""docstring for TitleGridsViewCtr"""
	def __init__(self, parent, params = {}):
		super(TitleGridsViewCtr, self).__init__();
		self._className_ = TitleGridsViewCtr.__name__;
	...
	def initUI(self, parent, params):
		# 创建视图UI类
		self.__ui = TitleGridsViewUI(parent, curPath = self._curPath, viewCtr = self, params = params);
		self.__ui.initView();
