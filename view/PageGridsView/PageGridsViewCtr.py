...
# @Last Modified time: 2019-03-16 13:46:02
...
class PageGridsViewCtr(object):
	...
	def __init__(self, parent, params = {}):
		...
		self._className_ = PageGridsViewCtr.__name__;
	...
	def initUI(self, parent, params):
		# 创建视图UI类
		self.__ui = PageGridsViewUI(parent, curPath = self._curPath, viewCtr = self, params = params);
		self.__ui.initView();
