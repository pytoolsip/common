...
# @Last Modified time: 2019-04-20 12:29:23
import os;
import wx;

from _Global import _GG;

from SearchToolViewUI import *;
...
class SearchToolViewCtr(object):
	"""docstring for SearchToolViewCtr"""
	def __init__(self, parent, params = {}):
		super(SearchToolViewCtr, self).__init__();
		self._className_ = SearchToolViewCtr.__name__;
	...
	def initUI(self, parent, params):
		# 创建视图UI类
		self.__ui = SearchToolViewUI(parent, curPath = self._curPath, viewCtr = self, params = params);
		self.__ui.initView();
