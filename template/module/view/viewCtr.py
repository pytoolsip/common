...
# @Last Modified time: 2019-01-12 17:06:47
import os;
import wx;
...
class TemplateViewCtr(object):
	...
	def __init__(self, parent, params = {}):
		...
		self.className_ = TemplateViewCtr.__name__;
	...
	def initUI(self, parent, params):
		# 创建视图UI类
		self.UI = TemplateViewUI(parent, curPath = self.curPath, viewCtr = self, params = params);
		self.UI.initView();
