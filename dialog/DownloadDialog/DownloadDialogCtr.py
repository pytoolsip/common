...
# @Last Modified time: 2019-03-16 13:45:41
import os;
import wx;

from _Global import _GG;

from DownloadDialogUI import *;
...
class DownloadDialogCtr(object):
	"""docstring for DownloadDialogCtr"""
	def __init__(self, parent, params = {}):
		super(DownloadDialogCtr, self).__init__();
		self._className_ = DownloadDialogCtr.__name__;
	...
	def initUI(self, parent, params):
		# 创建视图UI类
		self.__ui = DownloadDialogUI(parent, curPath = self._curPath, viewCtr = self, params = params);
