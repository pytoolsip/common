...
# @Last Modified time: 2019-03-26 18:25:37
import os;
import wx;

from _Global import _GG;

from ToolInfoDialogUI import *;
...
class ToolInfoDialogCtr(object):
	"""docstring for ToolInfoDialogCtr"""
	def __init__(self, parent, params = {}):
		super(ToolInfoDialogCtr, self).__init__();
		self._className_ = ToolInfoDialogCtr.__name__;
	...
	def initUI(self, parent, params):
		# 创建视图UI类
		self.__ui = ToolInfoDialogUI(parent, curPath = self._curPath, viewCtr = self, params = params);
