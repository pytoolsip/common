...
# @Last Modified time: 2019-03-16 13:45:46

import wx;

from _Global import _GG;

from ToolDevelopInfoDialogUI import *;
...
class ToolDevelopInfoDialogCtr(object):
	"""docstring for ToolDevelopInfoDialogCtr"""
	def __init__(self, parent, params = {}):
		super(ToolDevelopInfoDialogCtr, self).__init__();
		self._className_ = ToolDevelopInfoDialogCtr.__name__;
	...
	def initUI(self, parent, params):
		# 创建视图UI类
		self.__ui = ToolDevelopInfoDialogUI(parent, curPath = self._curPath, viewCtr = self, params = params);
